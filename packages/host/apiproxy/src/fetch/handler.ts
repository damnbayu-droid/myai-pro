...
import {
  credentialsDescribeRequestSchema, credentialsSetRequestSchema, credentialsUnsetRequestSchema, credentialsGetRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'credentials.get': { schema: credentialsGetRequestSchema, invoke: (api, r) => api.credentials.get(r) },
